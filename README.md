...
### CSV
```
✗ java -jar vikas_CMPE_202_Individual_Project_Modified.jar Vikas_CMPE_202_Individual_Project\input\input.csv Vikas_CMPE_202_Individual_Project\output\output.csv 
...
### JSON
```
✗ java -jar vikas_CMPE_202_Individual_Project_Modified.jar Vikas_CMPE_202_Individual_Project\input\input.json Vikas_CMPE_202_Individual_Project\output\output.json
Output is written to output.csv in output folder
```
```
✗ cat output.json
...
### XML
```
✗ java -jar vikas_CMPE_202_Individual_Project_Modified.jar Vikas_CMPE_202_Individual_Project\input\input.xml Vikas_CMPE_202_Individual_Project\output\output.xml
Output is written to output.csv in output folder
```
```
<ArrayList>
...
```
✗ java -jar vikas_CMPE_202_Individual_Project_Modified.jar
Invalid syntax. Usage: java Main <input filename> <output filename>
```

### Validation that input and output file extensions are same
```
✗ java -jar vikas_CMPE_202_Individual_Project_Modified.jar Vikas_CMPE_202_Individual_Project\input\input.csv Vikas_CMPE_202_Individual_Project\output\output.json
...
```
✗ java -jar Vikas_CMPE_202_Individual_Project\Vikas_CMPE_202_Individual_Project.jar Vikas_CMPE_202_Individual_Project\input.csv Vikas_CMPE_202_Individual_Project\output\output.csv
