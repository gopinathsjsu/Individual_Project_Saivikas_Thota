...
import com.vikas.creditcard.CreditCardFactorySelector;
import com.vikas.creditcard.OutputRecord;
                ...
                .map(r -> {
                    ...
                    try {
                        return new OutputRecord(
                                number,
                                new CreditCardFactorySelector().getCreditCard(number).createCreditCard().toString());
